...
description: "Access TDNET timely disclosures (適時開示) — get latest earnings, dividends, buybacks, M&A announcements from Tokyo Stock Exchange listed companies. No API key required."
metadata: {"openclaw":{"emoji":"📋","requires":{"bins":["tdnet-disclosure-mcp"]},"install":[{"id":"uv","kind":"uv","package":"tdnet-disclosure-mcp","bins":["tdnet-disclosure-mcp"],"label":"Install tdnet-disclosure-mcp (uv)"}]}}
---
