---
name: estat-mcp
description: "Search and retrieve Japanese government statistics (人口, GDP, CPI, 貿易) from e-Stat API — Japan's official open data portal with 3,000+ statistical tables."
metadata: {"openclaw":{"emoji":"📈","requires":{"bins":["estat-mcp"],"env":["ESTAT_APP_ID"]},"install":[{"id":"uv","kind":"uv","package":"estat-mcp","bins":["estat-mcp"],"label":"Install estat-mcp (uv)"}]}}
---
